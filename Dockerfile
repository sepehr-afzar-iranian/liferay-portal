...
COPY --chown=1000:1000 ./SAIN-bundles/bundles/tomcat-9.0.43/webapps/ROOT	/opt/liferay/tomcat-9.0.43/webapps/
COPY --chown=1000:1000 ./SAIN-bundles/bundles/osgi /opt/liferay/
