...
/**
 * Provides the local service interface for DDMTrackingCode. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DDMTrackingCodeLocalServiceUtil
 * @generated
 */
@CTAware
@ProviderType
...
public interface DDMTrackingCodeLocalService
	extends BaseLocalService, CTService<DDMTrackingCode>,
			PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.dynamic.data.mapping.service.impl.DDMTrackingCodeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ddm tracking code local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DDMTrackingCodeLocalServiceUtil} if injection and service tracking are not available.
	 */
