...
public class CommercePortletKeys {
	...
	public static final String COMMERCE_ADDRESS_CONTENT =
		"com_gelzobal_commerce_address_content_web_internal_portlet_" +
			"CommerceAddressContentPortlet";

	public static final String COMMERCE_AVAILABILITY_ESTIMATE =
		"com_gelzobal_commerce_availability_estimate_web_internal_portlet_" +
			"CommerceAvailabilityEstimatePortlet";

	public static final String COMMERCE_CART_CONTENT =
		"com_gelzobal_commerce_cart_content_web_internal_portlet_" +
	...
	public static final String COMMERCE_CHECKOUT =
		"com_gelzobal_commerce_checkout_web_internal_portlet_" +
			"CommerceCheckoutPortlet";

	public static final String COMMERCE_COUNTRY =
		"com_gelzobal_commerce_address_web_internal_portlet_" +
			"CommerceCountryPortlet";

	public static final String COMMERCE_HEALTH_CHECK =
		"com_gelzobal_commerce_health_status_web_internal_portlet_" +
	...
	public static final String COMMERCE_ORDER =
		"com_gelzobal_commerce_order_web_internal_portlet_CommerceOrderPortlet";
