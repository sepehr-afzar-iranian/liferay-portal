...
package com.liferay.portal.security.audit.event.generators.user.management;
...
public class AuditEventUserNotificationHandler
	...
	public AuditEventUserNotificationHandler() {
		setPortletId(AuditConstants.AUDIT_THRESHOLD_NOTIFICATION);
	}
