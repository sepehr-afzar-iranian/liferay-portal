...
public class AuditEventModelDocumentContributor
	...
	@Override
	public void contribute(Document document, AuditEvent auditEvent) {
		try {
			document.addKeyword(
				Field.CLASS_NAME_ID,
			...
			document.addKeyword(
				AuditField.SHORT_CLASS_NAME,
				_getShortClassName(auditEvent.getClassName()));
	...
	private String _getShortClassName(String className) {
		...
		if (Validator.isNotNull(className)) {
			shortClassName = className.substring(
