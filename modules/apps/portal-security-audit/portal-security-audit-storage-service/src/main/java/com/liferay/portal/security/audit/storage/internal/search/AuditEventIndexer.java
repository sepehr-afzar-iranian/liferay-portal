...
public class AuditEventIndexer
	extends BaseIndexer<AuditEvent> {
	...
	@Override
	protected void doDelete(AuditEvent auditEvent)
		throws Exception {
	...
	@Override
	protected void doReindex(AuditEvent auditEvent)
		throws Exception {
	...
	protected void doReindex(String className, long classPK) throws Exception {
		AuditEvent auditEvent =
				auditEventLocalService.getAuditEvent(classPK);
