...
package com.gelzobal.product.navigation.personal.menu.web.internal.control.menu;
...
import com.gelzobal.product.navigation.personal.menu.web.internal.constants.PersonalMenuWebKeys;
...
public class PersonalMenuProductNavigationControlMenuEntry
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=com.gelzobal.product.navigation.personal.menu.web)",
		unbind = "-"
	)
