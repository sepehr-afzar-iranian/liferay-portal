...
package com.gelzobal.product.navigation.simulation.device.internal.application.list;
...
import com.gelzobal.product.navigation.simulation.constants.ProductNavigationSimulationPortletKeys;
...
public class DevicePreviewPanelApp extends BaseJSPPanelApp {
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=com.gelzobal.product.navigation.simulation.device)",
		unbind = "-"
	)
