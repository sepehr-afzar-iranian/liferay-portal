...
package com.gelzobal.product.navigation.applications.menu.web.internal.product.navigation.control.menu;
...
public class ApplicationsMenuApplicationMenuProductNavigationControlMenuEntry
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=com.gelzobal.product.navigation.applications.menu.web)",
		unbind = "-"
	)
