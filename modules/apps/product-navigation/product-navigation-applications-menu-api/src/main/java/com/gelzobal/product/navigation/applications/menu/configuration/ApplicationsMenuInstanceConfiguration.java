...
package com.gelzobal.product.navigation.applications.menu.configuration;
...
@Meta.OCD(
	id = "com.gelzobal.product.navigation.applications.menu.configuration.ApplicationsMenuInstanceConfiguration",
