...
package com.gelzobal.product.navigation.personal.menu.configuration;
...
@Meta.OCD(
	id = "com.gelzobal.product.navigation.personal.menu.configuration.PersonalMenuConfiguration",
