...
package com.gelzobal.product.navigation.site.administration.internal.application.list;
...
public class SiteAdministrationPanelCategory extends BaseJSPPanelCategory {
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=com.gelzobal.product.navigation.site.administration)",
		unbind = "-"
	)
