...
package com.gelzobal.product.navigation.control.menu.web.internal;
...
import com.gelzobal.product.navigation.control.menu.web.internal.constants.ProductNavigationControlMenuWebKeys;
...
public class PortletHeaderProductNavigationControlMenuEntry
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=com.gelzobal.product.navigation.control.menu.web)",
		unbind = "-"
	)
