...
page import="com.gelzobal.item.selector.criteria.group.criterion.GroupItemSelectorCriterion" %><%@
...
page import="com.gelzobal.product.navigation.personal.menu.BasePersonalMenuEntry" %><%@
