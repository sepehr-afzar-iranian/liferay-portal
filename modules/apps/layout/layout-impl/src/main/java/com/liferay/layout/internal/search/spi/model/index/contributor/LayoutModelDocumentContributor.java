...
public class LayoutModelDocumentContributor
	...
	public void contribute(Document document, Layout layout) {
		...
		if ((httpServletRequest == null) || (httpServletResponse == null)) {
			...
			long[] segmentsExperienceId = _getSegmentsExperienceId(layout);
					...
					content =
						LayoutPageTemplateStructureRenderUtil.
							renderLayoutContent(
								...
								FragmentEntryLinkConstants.VIEW, null, locale,
	...
	private String _getLayoutContent(
			...
			long[] segmentsExperienceIds, ServiceContext serviceContext)
