...
package com.gelzobal.item.selector.url.web.internal;
...
import com.gelzobal.item.selector.url.web.internal.display.context.ItemSelectorURLViewDisplayContext;
...
public class ItemSelectorURLView
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.gelzobal.item.selector.url.web)",
		unbind = "-"
	)
