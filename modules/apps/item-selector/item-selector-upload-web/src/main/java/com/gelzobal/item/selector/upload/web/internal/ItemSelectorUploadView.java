...
package com.gelzobal.item.selector.upload.web.internal;
...
import com.gelzobal.item.selector.upload.web.internal.display.context.ItemSelectorUploadViewDisplayContext;
...
public class ItemSelectorUploadView
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.gelzobal.item.selector.upload.web)",
		unbind = "-"
	)
