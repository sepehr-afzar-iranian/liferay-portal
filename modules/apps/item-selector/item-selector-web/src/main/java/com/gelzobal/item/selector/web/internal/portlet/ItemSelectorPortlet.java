...
package com.gelzobal.item.selector.web.internal.portlet;
...
public class ItemSelectorPortlet extends MVCPortlet {
	...
	@Reference(
		target = "(&(release.bundle.symbolic.name=com.gelzobal.item.selector.web)(&(release.schema.version>=1.0.0)(!(release.schema.version>=2.0.0))))",
		unbind = "-"
	)
